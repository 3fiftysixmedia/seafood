...
$enable_business_hour = atbdp_get_option('enable_business_hour', 'atbdp_business_hour'); // yes or no
$enable_bh_on_page = atbdp_get_option('enable_bh_on_page', 'atbdp_business_hour'); // yes or no
$text247 = atbdp_get_option('text247', 'atbdp_business_hour', __('Open 24/7', ATBDP_TEXTDOMAIN)); // text for 24/7 type listing
$business_hour_title = atbdp_get_option('business_hour_title', 'atbdp_business_hour', __('Business Hour', ATBDP_TEXTDOMAIN)); // text Business Hour Title
$business_hours = !empty($listing_info['bdbh']) ? atbdp_sanitize_array($listing_info['bdbh']) : array(); // arrays of days and times
            ...
            <div class="col-md-4 col-sm-4">
                <div class="directory_user_area">
                    ...
                    <div class="directory_user_area_form">
                        <a href="<?= esc_url(get_permalink(atbdp_get_option('add_listing_page','atbdp_general'))); ?>" class="directory_btn btn btn-default"><?php _e('Submit New Listing', ATBDP_TEXTDOMAIN); ?></a>
