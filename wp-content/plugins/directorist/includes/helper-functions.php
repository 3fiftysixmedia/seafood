...
if (!function_exists('get_fa_icons')){
    function  get_fa_icons() {
        return $iconsFA = array("fa-500px","fa-address-book","fa-address-book-o","fa-address-card","fa-address-card-o","fa-adjust","fa-adn","fa-align-center","fa-align-justify","fa-align-left","fa-align-right",
...
if (!function_exists('is_multiple_images_active')){
    ...
    function  is_multiple_images_active(){
        $enable = atbdp_get_option('enable_multiple_image', 'atbdp_multiple_image');
...
if (!function_exists('atbdp_get_registration_page_url')){
    function    atbdp_get_registration_page_url(){
        return get_permalink(atbdp_get_option('custom_registration', 'atbdp_general'));
    }
}
if (!function_exists('atbdp_get_user_dashboard_url')){
    function    atbdp_get_user_dashboard_url(){
        return get_permalink(atbdp_get_option('user_dashboard', 'atbdp_general'));
    }
}
