...
*   It is very easy to use. Many directory plugins are very hard to use and have many junky settings. But this plugin emphasizes on the easy of use that anyone can create an amazing classified website or directory listing site in a few minutes.
...
*  It has an option to display related listings.
*  It has an option to display popular listings.
*  It has an option to display ratings and reviews on each listing.
*  It supports custom widget for displaying popular listings.
*  Ability to show popular category of listing on Home page.
*  Auto suggestion in the search category and places.
*  It can be extended to increase more functionalities like showing Business hours, Multiple Image Upload etc. using extensions.
