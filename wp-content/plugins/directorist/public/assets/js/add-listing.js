(function ($) {
    ...
    $(document).on('click', '.removeSocialField', function(e){
        ...
        /* Act on the event */
        swal({
                title: atbdp_add_listing.i18n_text.ask_confirmation,
                text: atbdp_add_listing.i18n_text.ask_conf_sl_lnk_del,
                type: "warning",
    ...
    // Category
    $('#at_biz_dir-type').select2({
        placeholder: atbdp_add_listing.i18n_text.type_selection,
        allowClear: true
    });
...
jQuery(function($){
    ...
    delImgLink.on( 'click', function( event ){
        ...
        imgContainer.html( '<img src="' + atbdp_data.PublicAssetPath + 'images/no-image.jpg" alt="Listing Image" />' );
